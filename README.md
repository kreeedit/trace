...
## Network graph
The generated GEXF file can be opened by a variety of graph visualization software, such as [Gephi](https://gephi.org/), [Cytoscape](https://cytoscape.org/), and [Orange](https://orangedatamining.com/widget-catalog/networks/networkanalysis/). These applications enable the visualization of network data as a graph and the exploration of the relationships between nodes and edges, i.e. the straightforward connection between the analyzed documents.
